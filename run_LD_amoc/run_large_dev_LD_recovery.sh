...
#### NAMELIST ##############################################################
nameThisFile='run_large_dev_LD_recovery'
...
endblock=50          # ultimo blocco: ti definisce lunghezza integrazione
...
LYear=360     # 
startID=l207-y2500_r2_y6m1  # 0BCD (B: ocean state, C: atmospheric state, D: repeat)
...
sourcerestdir=/home/zappa/work/PLASIM/PLASIM-master/AMOC_LD_amoc_pos_ntraj100_k10_LBlock360_p1_startIDl207-y2500_r2/init/
plasimrestname=AMOC_LD_amoc_pos_ntraj100_k10_LBlock360_p1_startIDl207-y2500_r2_init.0001.0006
lsgrestname=AMOC_LD_amoc_pos_ntraj100_k10_LBlock360_p1_startIDl207-y2500_r2_lsginit.0001.0006
#
