...
startedyear=`printf '%04d' ${initblock}`
startID=l207-y${resty}_r2_y${startedyear}mAll  # 0BCD (B: ocean state, C: atmospheric state, D: repeat)
...
sourcerestdir=/home/cini/work/PLASIM-LD/AMOC_LD_amoc_pos_ntraj100_k3_LBlock360_p1_startIDl207-y${resty}_r2/init/block_${initblockdir}/



plasimrestname=AMOC_LD_amoc_pos_ntraj100_k3_LBlock360_p1_startIDl207-y${resty}_r2_init.0001.${initblockdir}
lsgrestname=AMOC_LD_amoc_pos_ntraj100_k3_LBlock360_p1_startIDl207-y${resty}_r2_lsginit.0001.${initblockdir}
#
