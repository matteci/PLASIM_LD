...
!     ************************************************
!     * Global Scalars For Noisy Restarts - added by *
!     * francesco.ragone@ens.lyon.fr on 12/01/2019   *
!     ************************************************

      integer :: kickrestart     =  1       ! add noise at restart for kickrestart > 0
      real :: epsrestart         =  0.0001  ! amplitude for noise at restart
